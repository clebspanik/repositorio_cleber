...
public class ProvaQuestoesRespostas {
    ...
    public String getQuestao02(){
        return "Cite pelo menos 3 situações onde a referência “this” pode ser\n" +
                "usada. E onde não pode ser usada? ";
    }

    public String getQuestao03(){
        return "Quais detalhes importantes podem ser observados na\n" +
    ...
    public String getResposta04(){
        return "O escopo pode ser conceituado como função que inicia e finaliza o programa e as próprias\n" +
